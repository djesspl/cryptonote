...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x68fdb;
...
const char     CRYPTONOTE_NAME[]                             = "djesspl";
...
const std::initializer_list<const char*> SEED_NODES = {"104.131.164.57:17236",
